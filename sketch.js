...
player = createSprite(displayWidth-1350, displayHeight-400, 50, 50);
 player.addImage(shooterImg)
   ...
   heart1.visible = false
    ...
    ground = createSprite(displayWidth-1350,860,500,20)

    ground2 = createSprite(displayWidth-1350,100,500,20)
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(1200,1500),random(500,700),40,40)
